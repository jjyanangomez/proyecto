                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href=""><i class="zmdi zmdi-graduation-cap"></i>&nbsp;&nbsp; Carrera</a></li>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <?php
                ...
                if(isset($_GET["id_Carrera"]) && isset($_GET["EditarCarrera"])){
                    $CarreraControl = new CarreraController();
                    $id = $_GET['id_Carrera'];
                    $listaCarrera=$CarreraControl->getCarrera($id);
                    echo '<div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Actualizar Carreras </div>
                    <form method="post" action="../dll/metodosCarrera.php?id_Carrera_ca='.$id.'&ActualizarCarrera">
                        <div class="row">
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                                <p style="color:#FF0000; font-weight: bold;">No se olvide de volver a seleccionar la facultad a la que pertenece y editar el nombre de la Carrera</p>
                            </div>
                            <div class="group-material" >
                                <span>Facultad</span>';
                        ...
                        echo '</div>
                                <div class="group-material">
                                    <input type="text" value ="'.$listaCarrera[1].'" class="material-control tooltips-general" id= "Carrera" name = "Carrera" placeholder="Escribe aquí la nueva Carrera" required="" maxlength="100" data-toggle="tooltip" data-placement="top" title="Solamente letras y Números">
                    ...
                    echo '<div class="container-flat-form">
                    <div class="title-flat-form title-flat-blue">Administrar Carreras </div>
                    <form method="post" action="../dll/add_Carrera.php">
                        <div class="row">
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material" >
                                <span>Facultad</span>';
                        ...
                        echo '</div>
                                <div class="group-material">
                                    <input type="text" value ="" class="material-control tooltips-general" id= "Carrera" name = "Carrera" placeholder="Escribe aquí la nueva Carrera" required="" maxlength="100" data-toggle="tooltip" data-placement="top" title="Solamente letras y Números">
                                    <span class="highlight"></span>
                                    <span class="bar"></span>
                                    <label>Carrera</label>
                                </div>
        ...
        <div class="container-fluid">
            <h2 class="text-center all-tittles" style="clear: both; margin: 25px 0;">Lista de Carreras por Area</h2>
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar">
                <?php
                    $Carrera = new CarreraController();
                    $Carrera->ListCarreraTabla();
                ?>
            </div>
        </div>
...
<script type="text/javascript">
        function preguntar(id){
            if(confirm("Esta seguro que desea Eliminar este Campo: ")){
                ...
                window.location.href = "../dll/metodosCarrera.php?id_Carrera="+id+"&EliminarCarrera";
            }
        }
        ;  
</script>
