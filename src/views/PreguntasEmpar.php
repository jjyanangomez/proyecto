...
<html lang="es">
<head>
    <title>Preguntas de Emparejamiento</title>
    <meta charset="utf-8">
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation" class="active"><a href="PreguntasEmpar.php">Preguntas de Emparejamiento</a></li>
            </ul>
        </div>
            ...
            <div class="container-flat-form">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                        <form autocomplete="off" method="post" id ="addQuestionTF" action ="../dll/add_PreguntaEmpar.php?usuario=<?php echo $_SESSION['IDBanco'];?>">
                            <div class="row">
                                <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                                    <div class="group-material">
                                        <input type="text" class="material-control tooltips-general" id = "PreguntaEmpar" name = "PreguntaEmpar" placeholder="Pregunta" required=""  data-toggle="tooltip" data-placement="top" title="Escriba la pregunta ">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Pregunta</label>
                                    </div>
                                    <div class="group-material">
                                        <input type="text" class="material-control tooltips-general" id = "Enunciado1" name = "Enunciado1" placeholder="Opcion #1(Deben de contar con menos de 20 caracteres)" required="" maxlength="20" pattern='[a-zA-ZáéíóúÁÉÍÓÚñÑ¡?:,.""¿!=()/*-+ 1234567890]{1,1000}' data-toggle="tooltip" data-placement="top" title="Escriba el primer Enunciado">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Primer Enunciado </label>
                                    </div>
                                    <div class="group-material">
                                        <input type="text" class="material-control tooltips-general" id = "ResEnunciado1" name = "ResEnunciado1" placeholder="Respuesta Correcta del primer enunciado" required="" maxlength="200" pattern='[a-zA-ZáéíóúÁÉÍÓÚñÑ¡?:,.""¿!=()/*-+ 1234567890]{1,1000}' data-toggle="tooltip" data-placement="top" title="Escriba la respuesta del primer enunciado">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Respuesta del primer enunciado</label>
                                    </div>
                                    <div class="group-material">
                                        <input type="text" class="material-control tooltips-general" id = "Enunciado2" name = "Enunciado2" placeholder="Opcion #2(Deben de contar con menos de 20 caracteres)" required="" maxlength="20" pattern='[a-zA-ZáéíóúÁÉÍÓÚñÑ¡?:,.""¿!=()/*-+ 1234567890]{1,1000}' data-toggle="tooltip" data-placement="top" title="Escriba el segundo Enunciado">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Segundo Enunciado </label>
                                    </div>
                                    <div class="group-material">
                                        <input type="text" class="material-control tooltips-general" id = "ResEnunciado2" name = "ResEnunciado2" placeholder="Respuesta Correcta del primer enunciado" required="" maxlength="200" pattern='[a-zA-ZáéíóúÁÉÍÓÚñÑ¡?:,.""¿!=()/*-+ 1234567890]{1,1000}' data-toggle="tooltip" data-placement="top" title="Escriba la respuesta del segundo enunciado">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Respuesta del segundo enunciado</label>
                                    </div>
                                    <div class="group-material">
                                        <input type="text" class="material-control tooltips-general" id = "Enunciado3" name = "Enunciado3" placeholder="Opcion #3(Deben de contar con menos de 20 caracteres)" required="" maxlength="20" pattern='[a-zA-ZáéíóúÁÉÍÓÚñÑ¡?:,.""¿!=()/*-+ 1234567890]{1,1000}' data-toggle="tooltip" data-placement="top" title="Debe de contar con letras y signos menos de numeros">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Tercer Enunciado </label>
                                    </div>
                                    <div class="group-material">
                                        <input type="text" class="material-control tooltips-general" id = "ResEnunciado3" name = "ResEnunciado3" placeholder="Respuesta Correcta del tercer enunciado" required="" maxlength="200" pattern='[a-zA-ZáéíóúÁÉÍÓÚñÑ¡?:,.""¿!=()/*-+ 1234567890]{1,1000}' data-toggle="tooltip" data-placement="top" title="Escriba la respuesta del tercer enunciado">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Respuesta del tercer enunciado</label>
                                    </div>
                                    <div class="group-material">
                                        <input type="text" class="material-control tooltips-general" id = "RetroalimentacionEmpar" name = "RetroalimentacionEmpar" placeholder="Retroalimentación" required="" maxlength="500" data-toggle="tooltip" data-placement="top" title="Escriba la Retroalimentación de la pregunta">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                    ...
                                    <p class="text-center">
                                        ...
                                        <button type="submit" class="btn btn-primary" value="GuardarPreguntaEmpar" name="GuardarPreguntaEmpar" ><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; Guardar</button>
                                    </p>
                                </div>
                            </div>
                        </form>
