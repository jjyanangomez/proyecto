<?php
    ...
    if(isset($_GET["id_Cuestionario"])&& isset($_GET["Codigo"])){
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">Sistema GamificEv <small>Reportes de los Estudiantes</small></h1>
            </div>
        </div>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane fade in active" id="statistics">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-12 lead">
                                <ol class="breadcrumb">
                                    <li><a href="report.php" >Cuestionarios Reportes</a></li>
                                    <li class="active">Lista de Estudiantes</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="text-center all-tittles">Historial de estudiantes</h3>
                                <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar">
                                <?php
                                    include("../Controller/ReportController.php");
                                    $controlA = new ReportController();
                                    $controlA->ListReportes($ID,$Codigo);
                                ?>
                                </div>
                            </div>
                        </div>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-center all-tittles">Detalles - Estudiante</h4>
                </div>
