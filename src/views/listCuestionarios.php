                ...
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li><a href=""><i class="zmdi zmdi-bookmark-outline zmdi-hc-fw"></i>&nbsp;&nbsp; Lista de Cuestionarios</a></li>
                        </ul>
                    </li>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">GamificEv <small>Listado de Cuestionarios</small></h1>
            </div>
        </div>
        <div class="container-fluid">
            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                <li role="presentation"><a href="CuestionarioNuevo.php">Cuestionarios</a></li>
                <li role="presentation" class="active"><a href="#">Lista de Cuestionarios</a></li>
            </ul>
        </div>
        ...
        <div class="container-fluid">
            <h2 class="text-center all-tittles" style="clear: both; margin: 25px 0;">Lista de Cuestionarios</h2>
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar">
                <?php
                    include("../Controller/CuestionarioController.php");
                    $controlA = new CuestionarioController();
                    $controlA->ListCuestionarios($_SESSION['Usuario']);
                ?>
            </div>
        </div>
    ...
    <script type="text/javascript">
        function preguntar(id){
            if(confirm("Esta seguro que desea Eliminar este Campo: ")){
                ...
                window.location.href = "../dll/metodosCuestionario.php?id_Cuestionario="+id+"&EliminarCuestionario";
            }
        }
        ;  
    </script>
